...
const PurchaseGame = (params: any) => {
	...
	const [pointsAvailable, setPointsAvailable] = useState(initialPointsAvailable);
	...
	return (
		<StandardLayout>
			...
			<KeyboardAvoidingScrollView 
				...
				<StyledText type='ListItemSubTitle' color={theme.lightGrey}>{`Access tracking for ${actions.translateGameName(gameId)} for`}</StyledText>
				<Spacing height={8} />
				<StyledText type='ListItemTitleBold' color={theme.lightGrey}>{`3.99 ?`}</StyledText>
				<Spacing height={8} />
