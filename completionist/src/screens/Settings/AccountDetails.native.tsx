	...
	return (
		<StandardLayout>
			<NavigationHeader
				...
				isForm={viewModel.userInfo.username.changed || viewModel.userInfo.email.changed}
				leftAction='back'
			/>
			<>
				...
				>
					...
					<TextInput
						...
						inputStyle='text'
						onChangeText={(value: string): void => actions.setUserInfo({
							...viewModel.userInfo,
							username: { value: value, changed: value !== viewModel.user.username }
						})}
						onReset={(): void => actions.setUserInfo({
							...viewModel.userInfo,
					...
					<TextInput
						...
						onChangeText={(value: string): void => actions.setUserInfo({
							...viewModel.userInfo,
							email: { value: value, changed: value !== viewModel.user.email }
						})}
						onReset={(): void => actions.setUserInfo({
							...viewModel.userInfo,
					...
					<Condition condition={viewModel.showChangePw}>
						...
						<TextInput
							...
							onChangeText={(value: string): void => actions.setUserInfo({
								...viewModel.userInfo,
								currentPw: { value: value, changed: value !== viewModel.user.pw }
							})}
							onReset={(): void => actions.setUserInfo({
								...viewModel.userInfo,
